...
public class FilteringMoleculeViewer extends MoleculeViewer {
	...
	private static ILoggingTool logger = LoggingToolFactory
			.createLoggingTool(FilteringMoleculeViewer.class);
	...
	public FilteringMoleculeViewer(ReaccsMDLRXNReader reader, String fileName)
			throws Exception {
	...
	protected void generateImage() throws Exception {
		...
		try {
			...
			if (sqt.matches(reactant)) {
				List<List<Integer>> matchingAtomsList = sqt
	...
	public void actionPerformed(ActionEvent e) {
		if (!CANCEL.equals(e.getActionCommand())) {
			...
			swingWorker = new FilteringMoleculeViewerWorker(this, e
					.getActionCommand());
			swingWorker.execute();
		} else {
