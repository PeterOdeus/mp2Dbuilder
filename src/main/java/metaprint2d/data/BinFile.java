...
import metaprint2d.FingerprintData;
 ...
 public class BinFile
 {
     ...
     throws IOException
   {
     ...
     parse(is, new BinDataHandler() {
         @Override
         public void numFingerprints(int n) {
 ...
 abstract class BinDataHandler {
     public abstract void numFingerprints(int numFingerprints);
     public abstract void entry(FPLevel[] levels, int rcount, int scount);
 }
