...
/* 101 */             if (this.reactionSmarts != null) {
/* 102 */               throw new IllegalArgumentException("Argument -rfile already specified");
             }
/* 104 */             if (!(it.hasNext())) {
/* 105 */               throw new IllegalArgumentException("Argument -rfile missing required file name");
             }
/* 107 */             String fileName = (String)it.next();
/* 108 */             readReactionSmarts(fileName);
/* 113 */             LOG.info(new Object[] { "Reaction SMARTS: " + this.reactionSmarts });
           }
...
/* 243 */       throw new Exception("Input file not found: " + infile);
     }
